...
- **復元できたACには何も返さない。**判定するのは復元の可否だけで、精度・網羅・言い回しの改善案は挙げない。⚠ **安全側へ倒して「足りない」と答えると、判定の役が指摘を作る役に変わる**
- **ACを増やせという形の指摘をしない。**例外は、渡された1文が約束していることをどのACも覆っていないと見えたときで、そのときはその1点だけを挙げる

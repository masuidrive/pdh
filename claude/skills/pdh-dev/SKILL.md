...
`CLAUDE.md` と、それが読ませる `product-brief.md` / `PDH-AGENTS.md` は既に context にある。ここで開くのは ticket file / note file / progress file（`ticket.sh start`/`restore` 出力の `ticket:`/`note:` パスと、同じ dir の `progress.md`）だけ。
